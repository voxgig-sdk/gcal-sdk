...
class ChannelEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GCAL_TEST_CHANNEL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function channel_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GCAL_TEST_CHANNEL_ENTID");
