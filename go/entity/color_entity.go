...
func NewColorEntity(client *core.GcalSDK, entopts map[string]any) *ColorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ColorEntity) GetName() string { return e.name }
...
func (e *ColorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ColorEntity) Deleted() bool {
	return e.deleted
}


func (e *ColorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewColorEntity(e.client, opts)
}

func (e *ColorEntity) Data(args ...any) any {
...
func (e *ColorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Color; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ColorEntity) DataTyped(data ...Color) Color {
	if len(data) > 0 {
		return typedFrom[Color](e.Data(asMap(data[0])))
	}
	return typedFrom[Color](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Color (all fields
// optional at the wire level).
func (e *ColorEntity) MatchTyped(match ...Color) Color {
	if len(match) > 0 {
		return typedFrom[Color](e.Match(asMap(match[0])))
	}
	return typedFrom[Color](e.Match())
}
...
func (e *ColorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ColorEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ColorLoadMatch and returns an Color. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ColorEntity) LoadTyped(reqmatch ColorLoadMatch, ctrl map[string]any) (Color, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Color{}, err
	}
	return typedFrom[Color](res), nil
}



func (e *ColorEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ColorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ColorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ColorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ColorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
