...
(0, node_test_1.describe)('FreeBusyEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != free_busy_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/free_busy/FreeBusyTestData.json');
    ...
    let idmap = transform(['free_busy01', 'free_busy02', 'free_busy03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=FreeBusyEntity.test.js.map