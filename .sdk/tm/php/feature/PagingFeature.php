...
class GcalPagingFeature extends GcalBaseFeature
{
    ...
    private function _graphql_pre_request(GcalContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(GcalContext $ctx): bool
    {
