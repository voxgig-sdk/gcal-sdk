...
(0, node_test_1.describe)('StopEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "stop", "op": {}, "relations": { "ancestors": [] }, "key$": "stop", "name__orig": "stop", "Name": "Stop", "name_": "stop", "name-": "stop", "NAME": "STOP", "index$": 10 }, { "active": true, "entity": "stop", "key$": "BasicStopFlow", "kind": "basic", "name": "BasicStopFlow", "param": {}, "step": [] }, 'Stop');
        }
...
function basicSetup(extra) {
    ...
    const env = (0, utility_1.envOverride)({
        'GCAL_TEST_STOP_ENTID': idmap,
        'GCAL_TEST_LIVE': 'FALSE',
        'GCAL_TEST_EXPLAIN': 'FALSE',
        'GCAL_APIKEY': '',
    });
    idmap = env['GCAL_TEST_STOP_ENTID'];
    const live = 'TRUE' === env.GCAL_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['GCAL_TEST_STOP_ENTID'];
