...
class CalendarEntity
{
     ...
     *
     * @param CalendarCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CalendarCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Calendar|array The created Calendar as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
     ...
     *
     * @param CalendarUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CalendarUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Calendar|array The updated Calendar as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Calendar matching the given criteria.
     *
     * @param CalendarRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CalendarRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Calendar|array The removed Calendar as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
