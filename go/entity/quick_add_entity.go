...
func NewQuickAddEntity(client *core.GcalSDK, entopts map[string]any) *QuickAddEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QuickAddEntity) GetName() string { return e.name }
...
func (e *QuickAddEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QuickAddEntity) Deleted() bool {
	return e.deleted
}


func (e *QuickAddEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQuickAddEntity(e.client, opts)
}

func (e *QuickAddEntity) Data(args ...any) any {
...
func (e *QuickAddEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an QuickAdd; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QuickAddEntity) DataTyped(data ...QuickAdd) QuickAdd {
	if len(data) > 0 {
		return typedFrom[QuickAdd](e.Data(asMap(data[0])))
	}
	return typedFrom[QuickAdd](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through QuickAdd (all fields
// optional at the wire level).
func (e *QuickAddEntity) MatchTyped(match ...QuickAdd) QuickAdd {
	if len(match) > 0 {
		return typedFrom[QuickAdd](e.Match(asMap(match[0])))
	}
	return typedFrom[QuickAdd](e.Match())
}
...
func (e *QuickAddEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QuickAddEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *QuickAddEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *QuickAddEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *QuickAddEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QuickAddEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QuickAddEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
