...
func NewFreeBusyEntity(client *core.GcalSDK, entopts map[string]any) *FreeBusyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FreeBusyEntity) GetName() string { return e.name }
...
func (e *FreeBusyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FreeBusyEntity) Deleted() bool {
	return e.deleted
}


func (e *FreeBusyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFreeBusyEntity(e.client, opts)
}

func (e *FreeBusyEntity) Data(args ...any) any {
...
func (e *FreeBusyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FreeBusy; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FreeBusyEntity) DataTyped(data ...FreeBusy) FreeBusy {
	if len(data) > 0 {
		return typedFrom[FreeBusy](e.Data(asMap(data[0])))
	}
	return typedFrom[FreeBusy](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FreeBusy (all fields
// optional at the wire level).
func (e *FreeBusyEntity) MatchTyped(match ...FreeBusy) FreeBusy {
	if len(match) > 0 {
		return typedFrom[FreeBusy](e.Match(asMap(match[0])))
	}
	return typedFrom[FreeBusy](e.Match())
}
...
func (e *FreeBusyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FreeBusyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FreeBusyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *FreeBusyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FreeBusyCreateData and returns an FreeBusy. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FreeBusyEntity) CreateTyped(reqdata FreeBusyCreateData, ctrl map[string]any) (FreeBusy, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return FreeBusy{}, err
	}
	return typedFrom[FreeBusy](res), nil
}



func (e *FreeBusyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FreeBusyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FreeBusyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
