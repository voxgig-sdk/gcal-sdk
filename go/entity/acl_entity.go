...
func NewAclEntity(client *core.GcalSDK, entopts map[string]any) *AclEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AclEntity) GetName() string { return e.name }
...
func (e *AclEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AclEntity) Deleted() bool {
	return e.deleted
}


func (e *AclEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAclEntity(e.client, opts)
}

func (e *AclEntity) Data(args ...any) any {
...
func (e *AclEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Acl; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AclEntity) DataTyped(data ...Acl) Acl {
	if len(data) > 0 {
		return typedFrom[Acl](e.Data(asMap(data[0])))
	}
	return typedFrom[Acl](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Acl (all fields
// optional at the wire level).
func (e *AclEntity) MatchTyped(match ...Acl) Acl {
	if len(match) > 0 {
		return typedFrom[Acl](e.Match(asMap(match[0])))
	}
	return typedFrom[Acl](e.Match())
}
...
func (e *AclEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AclEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AclLoadMatch and returns an Acl. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AclEntity) LoadTyped(reqmatch AclLoadMatch, ctrl map[string]any) (Acl, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Acl{}, err
	}
	return typedFrom[Acl](res), nil
}




func (e *AclEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AclListMatch and returns []Acl. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AclEntity) ListTyped(reqmatch AclListMatch, ctrl map[string]any) ([]Acl, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Acl](res), nil
}




func (e *AclEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AclCreateData and returns an Acl. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AclEntity) CreateTyped(reqdata AclCreateData, ctrl map[string]any) (Acl, error) {
...
func (e *AclEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// AclUpdateData and returns an Acl. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *AclEntity) UpdateTyped(reqdata AclUpdateData, ctrl map[string]any) (Acl, error) {
...
func (e *AclEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AclRemoveMatch and returns an Acl. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AclEntity) RemoveTyped(reqmatch AclRemoveMatch, ctrl map[string]any) (Acl, error) {
...
func (e *AclEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
