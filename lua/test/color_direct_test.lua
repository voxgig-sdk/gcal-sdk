...
describe("ColorDirect", function()
  it("should direct-load-color", function()
    local setup = color_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-color", setup.live and "live" or "unit")
...
function color_direct_setup(mockres)
