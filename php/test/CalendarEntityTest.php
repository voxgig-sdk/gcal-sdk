...
class CalendarEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GCAL_TEST_CALENDAR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $calendar_ref01_data_result = $calendar_ref01_ent->create($calendar_ref01_data, null);
        $calendar_ref01_data = Helpers::to_map(is_object($calendar_ref01_data_result) && method_exists($calendar_ref01_data_result, 'data_get') ? $calendar_ref01_data_result->data_get() : $calendar_ref01_data_result);
        $this->assertNotNull($calendar_ref01_data);
        $this->assertNotNull($calendar_ref01_data["id"]);
        ...
        $calendar_ref01_resdata_up0 = Helpers::to_map(is_object($calendar_ref01_resdata_up0_result) && method_exists($calendar_ref01_resdata_up0_result, 'data_get') ? $calendar_ref01_resdata_up0_result->data_get() : $calendar_ref01_resdata_up0_result);
        ...
        $calendar_ref01_ent->remove($calendar_ref01_match_rm0, null);
...
function calendar_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GCAL_TEST_CALENDAR_ENTID");
