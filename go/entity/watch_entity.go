...
func NewWatchEntity(client *core.GcalSDK, entopts map[string]any) *WatchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WatchEntity) GetName() string { return e.name }
...
func (e *WatchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WatchEntity) Deleted() bool {
	return e.deleted
}


func (e *WatchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWatchEntity(e.client, opts)
}

func (e *WatchEntity) Data(args ...any) any {
...
func (e *WatchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Watch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WatchEntity) DataTyped(data ...Watch) Watch {
	if len(data) > 0 {
		return typedFrom[Watch](e.Data(asMap(data[0])))
	}
	return typedFrom[Watch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Watch (all fields
// optional at the wire level).
func (e *WatchEntity) MatchTyped(match ...Watch) Watch {
	if len(match) > 0 {
		return typedFrom[Watch](e.Match(asMap(match[0])))
	}
	return typedFrom[Watch](e.Match())
}
...
func (e *WatchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WatchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *WatchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WatchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WatchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WatchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WatchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
