...
class WatchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WatchEntity($this->_client, $opts);
    }

    /**
     * @param Watch|array $args Watch data (assoc-array) to store.
     */
    ...
    /**
     * @return Watch|array The current Watch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Watch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Watch fields).
     */
