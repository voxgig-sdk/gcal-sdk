...
class GcalRatelimitFeature extends GcalBaseFeature
{
    ...
    private function _acquire(GcalContext $ctx): void
    {
    ...
    private function _track(GcalContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
