...
func NewCalendarEntity(client *core.GcalSDK, entopts map[string]any) *CalendarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CalendarEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CalendarEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CalendarCreateData and returns an Calendar. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CalendarEntity) CreateTyped(reqdata CalendarCreateData, ctrl map[string]any) (Calendar, error) {
...
func (e *CalendarEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// CalendarUpdateData and returns an Calendar. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CalendarEntity) UpdateTyped(reqdata CalendarUpdateData, ctrl map[string]any) (Calendar, error) {
...
func (e *CalendarEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CalendarRemoveMatch and returns an Calendar. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CalendarEntity) RemoveTyped(reqmatch CalendarRemoveMatch, ctrl map[string]any) (Calendar, error) {
