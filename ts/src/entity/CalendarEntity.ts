...
class CalendarEntity extends GcalEntityBase<Calendar> {
  ...
  async create(this: any, reqdata?: CalendarCreateData, ctrl?: Control): Promise<CalendarEntity> {
  ...
  async update(this: any, reqdata?: CalendarUpdateData, ctrl?: Control): Promise<CalendarEntity> {
  ...
  async remove(
    this: any, reqmatch?: CalendarRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CalendarEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
