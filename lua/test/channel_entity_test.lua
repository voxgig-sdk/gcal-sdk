...
describe("ChannelEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GCAL_TEST_CHANNEL_ENTID JSON to run live")
      return
    end
...
function channel_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GCAL_TEST_CHANNEL_ENTID")
