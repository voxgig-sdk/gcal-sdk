...
class GcalTimeoutFeature extends GcalBaseFeature
{
    ...
    private function _with_timeout(GcalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GcalContext $_ctx, float $ms): void
    {
        $client = $this->client;
