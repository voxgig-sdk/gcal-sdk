...
class CalendarListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CalendarListEntity($this->_client, $opts);
    }

    /**
     * @param CalendarList|array $args CalendarList data (assoc-array) to store.
     */
    ...
    /**
     * @return CalendarList|array The current CalendarList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CalendarList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CalendarList fields).
     */
    ...
    /**
     * Load a single CalendarList.
     *
     * @param CalendarListLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CalendarListLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CalendarList|array The loaded CalendarList as an assoc-array at the
    ...
    /**
     * List CalendarList items matching the given filter.
     *
     * @param CalendarListListMatch|array|null $reqmatch Match filter (any subset
     *   of CalendarList fields) as an assoc-array; CalendarListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CalendarList[]|array A list of CalendarList items as assoc-arrays at
     ...
     *
     * @param CalendarListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CalendarListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CalendarList|array The created CalendarList as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
     ...
     *
     * @param CalendarListUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CalendarListUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CalendarList|array The updated CalendarList as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an CalendarList matching the given criteria.
     *
     * @param CalendarListRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CalendarListRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CalendarList|array The removed CalendarList as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
