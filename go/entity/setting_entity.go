...
func NewSettingEntity(client *core.GcalSDK, entopts map[string]any) *SettingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SettingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SettingLoadMatch and returns an Setting. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SettingEntity) LoadTyped(reqmatch SettingLoadMatch, ctrl map[string]any) (Setting, error) {
...
func (e *SettingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
