...
class QuickAddEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new QuickAddEntity($this->_client, $opts);
    }

    /**
     * @param QuickAdd|array $args QuickAdd data (assoc-array) to store.
     */
    ...
    /**
     * @return QuickAdd|array The current QuickAdd data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of QuickAdd fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of QuickAdd fields).
     */
