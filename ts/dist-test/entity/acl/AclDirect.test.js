...
(0, node_test_1.describe)('AclDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-acl', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-acl', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-acl', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-acl', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["calendar01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GCAL_TEST_ACL_ENTID'];
...
//# sourceMappingURL=AclDirect.test.js.map