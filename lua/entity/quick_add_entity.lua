-- Gcal SDK QuickAdd entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local QuickAddEntity = {}
QuickAddEntity.__index = QuickAddEntity


function QuickAddEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, QuickAddEntity)
  self._name = "quick_add"
  self._client = client
...
function QuickAddEntity:get_name()
  return self._name
end


function QuickAddEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return QuickAddEntity.new(self._client, opts)
end
...
function QuickAddEntity:mark_deleted()
  self._deleted = true
end


function QuickAddEntity:deleted()
  return true == self._deleted
end


function QuickAddEntity:data_set(args)
  if args ~= nil then
...
function QuickAddEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function QuickAddEntity:match_set(args)
  if args ~= nil then
...
function QuickAddEntity:match_get()
...
function QuickAddEntity:stream(action, args, callopts)
...
function QuickAddEntity:_run_op(ctx, post_done)
  local utility = self._utility
