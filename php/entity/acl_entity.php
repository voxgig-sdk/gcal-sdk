...
class AclEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AclEntity($this->_client, $opts);
    }

    /**
     * @param Acl|array $args Acl data (assoc-array) to store.
     */
    ...
    /**
     * @return Acl|array The current Acl data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Acl fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Acl fields).
     */
     ...
     * Load a single Acl.
     *
     * @param AclLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AclLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Acl|array The loaded Acl as an assoc-array at the
    ...
    /**
     * List Acl items matching the given filter.
     *
     * @param AclListMatch|array|null $reqmatch Match filter (any subset
     *   of Acl fields) as an assoc-array; AclListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Acl[]|array A list of Acl items as assoc-arrays at
     ...
     * Create a new Acl.
     *
     * @param AclCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AclCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Acl|array The created Acl as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
     ...
     *
     * @param AclUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AclUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Acl|array The updated Acl as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Acl matching the given criteria.
     *
     * @param AclRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AclRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Acl|array The removed Acl as an assoc-array at the
     *   SDK boundary; throws GcalError on failure (item-5 convention).
     */
