...
local AclEntity = {}
AclEntity.__index = AclEntity


function AclEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AclEntity)
  self._name = "acl"
  self._client = client
...
function AclEntity:get_name()
  return self._name
end


function AclEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AclEntity.new(self._client, opts)
end
...
function AclEntity:mark_deleted()
  self._deleted = true
end


function AclEntity:deleted()
  return true == self._deleted
end


function AclEntity:data_set(args)
  if args ~= nil then
...
function AclEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AclEntity:match_set(args)
  if args ~= nil then
...
function AclEntity:stream(action, args, callopts)
...
---@param reqmatch AclLoadMatch
---@param ctrl? table
---@return Acl
---@return string? err
function AclEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch AclListMatch
---@param ctrl? table
---@return Acl[]
---@return string? err
function AclEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata AclCreateData
---@param ctrl? table
---@return Acl
---@return string? err
function AclEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AclUpdateData
---@param ctrl? table
---@return Acl
---@return string? err
function AclEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch AclRemoveMatch
---@param ctrl? table
---@return Acl
---@return string? err
function AclEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function AclEntity:_run_op(ctx, post_done)
  local utility = self._utility
