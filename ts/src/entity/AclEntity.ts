...
class AclEntity extends GcalEntityBase<Acl> {
  ...
  make(this: AclEntity) {
    return new AclEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AclLoadMatch, ctrl?: Control): Promise<AclEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Acl> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: AclListMatch, ctrl?: Control): Promise<AclEntity[]> {
  ...
  async create(this: any, reqdata?: AclCreateData, ctrl?: Control): Promise<AclEntity> {
  ...
  async update(this: any, reqdata?: AclUpdateData, ctrl?: Control): Promise<AclEntity> {
  ...
  async remove(
    this: any, reqmatch?: AclRemoveMatch, ctrl?: Control,
  ): Promise<AclEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<AclEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
