...
local CalendarListEntity = {}
CalendarListEntity.__index = CalendarListEntity


function CalendarListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CalendarListEntity)
  self._name = "calendar_list"
  self._client = client
...
function CalendarListEntity:get_name()
  return self._name
end


function CalendarListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CalendarListEntity.new(self._client, opts)
end
...
function CalendarListEntity:mark_deleted()
  self._deleted = true
end


function CalendarListEntity:deleted()
  return true == self._deleted
end


function CalendarListEntity:data_set(args)
  if args ~= nil then
...
function CalendarListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CalendarListEntity:match_set(args)
  if args ~= nil then
...
function CalendarListEntity:match_get()
...
function CalendarListEntity:stream(action, args, callopts)
...
---@param reqmatch CalendarListLoadMatch
---@param ctrl? table
---@return CalendarList
---@return string? err
function CalendarListEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CalendarListListMatch
---@param ctrl? table
---@return CalendarList[]
---@return string? err
function CalendarListEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata CalendarListCreateData
---@param ctrl? table
---@return CalendarList
---@return string? err
function CalendarListEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CalendarListUpdateData
---@param ctrl? table
---@return CalendarList
---@return string? err
function CalendarListEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch CalendarListRemoveMatch
---@param ctrl? table
---@return CalendarList
---@return string? err
function CalendarListEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function CalendarListEntity:_run_op(ctx, post_done)
  local utility = self._utility
