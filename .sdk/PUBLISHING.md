...
|---|---|---|
| `js/` | @voxgig-sdk/gcal-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/gcal | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/gcal-js \
      --repository voxgig-sdk/gcal-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/gcal-js` shows it, and
`npm trust revoke @voxgig-sdk/gcal-js --id=<id>` removes it.
