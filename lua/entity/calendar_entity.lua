...
---@param reqdata CalendarCreateData
---@param ctrl? table
---@return Calendar
---@return string? err
function CalendarEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CalendarUpdateData
---@param ctrl? table
---@return Calendar
---@return string? err
function CalendarEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch CalendarRemoveMatch
---@param ctrl? table
---@return Calendar
---@return string? err
function CalendarEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
