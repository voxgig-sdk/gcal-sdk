...
class FreeBusyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FreeBusyEntity($this->_client, $opts);
    }

    /**
     * @param FreeBusy|array $args FreeBusy data (assoc-array) to store.
     */
    ...
    /**
     * @return FreeBusy|array The current FreeBusy data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FreeBusy fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FreeBusy fields).
     */
     ...
     *
     * @param FreeBusyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FreeBusyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FreeBusy|array The created FreeBusy as an assoc-array at the
