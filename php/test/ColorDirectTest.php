...
class ColorDirectTest extends TestCase
{
    public function test_direct_load_color(): void
    {
        $setup = color_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-color", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
