...
class FreeBusyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FreeBusyEntity(self._client, opts)
    ...
    def create(self, reqdata: FreeBusyCreateData, ctrl=None) -> FreeBusy:
        utility = self._utility
