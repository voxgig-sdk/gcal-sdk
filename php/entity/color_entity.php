...
class ColorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ColorEntity($this->_client, $opts);
    }

    /**
     * @param Color|array $args Color data (assoc-array) to store.
     */
    ...
    /**
     * @return Color|array The current Color data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Color fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Color fields).
     */
     ...
     * Load a single Color.
     *
     * @param ColorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ColorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Color|array The loaded Color as an assoc-array at the
