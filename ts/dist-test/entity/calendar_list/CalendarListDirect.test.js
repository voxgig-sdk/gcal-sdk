...
(0, node_test_1.describe)('CalendarListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-calendar_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-calendar_list', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-calendar_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-calendar_list', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.GCAL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GcalSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.GCAL_APIKEY,
        }));
        let idmap = env['GCAL_TEST_CALENDAR_LIST_ENTID'];
...
//# sourceMappingURL=CalendarListDirect.test.js.map